        ...
        <section className="landing-container">
            ...
            <div className="landing-content">
                ...
                <div className="landing-section landing-section1">
                    ...
                    <p>Our team's spent a lot of time with Gmail -- and even MORE time getting frustrated with it. Tagger is powered by your Gmail account and features a new & improved design, custom-made for your modern life.</p>
                    </div>
                    </div>
                    <div className="bottom-border"></div>
                    ...
                    <p>Have you ever spent too long searching for an old email thread? Us too! Tagger was built to auto-tag and sort your messages using advanced Machine Learning tools, so you'll never lose track of the conversations that matter to you.</p>
                    </div>
